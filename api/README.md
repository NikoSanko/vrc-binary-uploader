...
画像やその他データを独自形式に変換したファイルをアップロードするAPI
...
- API version: 1.0.0
- Build date: 2025-11-26T05:26:53.110123968Z[Etc/UTC]
...
cargo run --example client UpdateMergedImage
cargo run --example client UploadImage
cargo run --example client UploadMergedImage
```
...
------------- | ------------- | -------------
[**ping**](docs/default_api.md#ping) | **GET** /ping | 疎通確認
[**updateMergedImage**](docs/default_api.md#updateMergedImage) | **PUT** /merged-images | 複数画像を束ねたファイルの指定枚目だけ更新する
[**uploadImage**](docs/default_api.md#uploadImage) | **POST** /images | １枚の画像をDDS形式に変換し、ストレージにアップロードする
[**uploadMergedImage**](docs/default_api.md#uploadMergedImage) | **POST** /merged-images | 複数枚の画像をDDS形式に変換し、1ファイルにまとめ、ストレージにアップロードする
